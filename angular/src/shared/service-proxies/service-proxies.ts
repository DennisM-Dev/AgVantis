...
@Injectable()
export class AssociationServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    changeEmail(body: ChangeAssociationEmailDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Association/ChangeEmail";
        url_ = url_.replace(/[?&]$/, "");
...
export class ChangeAssociationEmailDto implements IChangeAssociationEmailDto {
    currentEmailAddress: string | undefined;
    newEmailAddress: string | undefined;

    constructor(data?: IChangeAssociationEmailDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.currentEmailAddress = _data["currentEmailAddress"];
            this.newEmailAddress = _data["newEmailAddress"];
        }
    }

    static fromJS(data: any): ChangeAssociationEmailDto {
        data = typeof data === 'object' ? data : {};
        let result = new ChangeAssociationEmailDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["currentEmailAddress"] = this.currentEmailAddress;
        data["newEmailAddress"] = this.newEmailAddress;
        return data;
    }

    clone(): ChangeAssociationEmailDto {
        const json = this.toJSON();
        let result = new ChangeAssociationEmailDto();
        result.init(json);
        return result;
...
export interface IChangeAssociationEmailDto {
    currentEmailAddress: string | undefined;
    newEmailAddress: string | undefined;
}
